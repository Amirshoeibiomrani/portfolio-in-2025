...
const Header = () => {
    ...
    window.addEventListener("scroll", function () {
        ...
        // When the header is higher than 200 viewport height, add the scroll-header class to a tag with the header tag
    ...
    return (
        <header className='header'>
            <nav className="nav container">
                ...
                <div className={Toggle ? "nav__menu show__menu" : 
                "nav__menu"}>
                    ...
                    <i 
                    className="uil uil-times nav__close" onClick={() => showMenu(!Toggle)}></i>
                </div>
